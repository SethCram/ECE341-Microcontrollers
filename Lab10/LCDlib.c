...
//clears specified LCD line:
int ClearLCDline( int lineNum ) //also rets cursor to start of cleared line
{
	char clearStr[] = "                "; //16 spaces to clear line

	switch ( lineNum )
	{
		case 1: //line 1
			//change cursor to line 1 start:
			ChangeCursorLoc( 1 );
...
//changes loc of cursor to start of specified line:
int ChangeCursorLoc( int lineNum ) //doesnt support to any loc, just beginning of lines
{
	//should poll for busy flag just incase valid input?
